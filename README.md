...
## Aim: To  
configure  Dragino LPS8 Indoor LoRaWAN gateway for things  network 
## Components required: 
...
![output](https://github.com/jhansi21005096/EXPERIMENT-06-CONFIGURING-INDOOR-GATEWAY-FOR-LORAWAN/blob/main/output.jpeg)
